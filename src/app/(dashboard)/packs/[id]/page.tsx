  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className="rounded-xl border border-border bg-card glass p-3.5 flex flex-col gap-1">
      ...
      {/* Stock sync status */}
      <div className="rounded-xl border border-border bg-card glass px-4 py-3 flex items-center gap-3">
